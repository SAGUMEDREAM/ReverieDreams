...
public record FloatingSphereFeatureConfig(ResourceLocation blockId, int minRadius, int maxRadius, int minY, int maxY,
    ...
    public static final Codec<FloatingSphereFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("block_id").forGetter(cfg -> cfg.blockId),
