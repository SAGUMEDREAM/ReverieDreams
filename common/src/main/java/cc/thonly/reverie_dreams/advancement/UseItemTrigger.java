...
public class UseItemTrigger
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player,
        ...
        public static Criterion<TriggerInstance> usedItem() {
            return RDCriteriaTriggers.USE_ITEM.value().createCriterion(new TriggerInstance(Optional.empty(), Optional.empty()));
        }
        ...
        public static Criterion<TriggerInstance> usedItem(ItemPredicate.Builder builder) {
            return RDCriteriaTriggers.USE_ITEM.value().createCriterion(new TriggerInstance(Optional.empty(), Optional.of(builder.build())));
        }
