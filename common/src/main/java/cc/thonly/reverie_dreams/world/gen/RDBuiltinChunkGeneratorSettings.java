...
public class RDBuiltinChunkGeneratorSettings {
    ...
    public static void bootstrap(BootstrapContext<NoiseGeneratorSettings> context) {
        ...
        NoiseGeneratorSettings moon = new NoiseGeneratorSettings(
                NoiseSettings.create(-32, 160, 2, 1),
                ...
                new NoiseRouter(
                        ...
                        DensityFunctions.zero(),
                        DensityFunctions.zero(),
                        NoiseRouterData.slide(DensityFunctions.constant(-0.703125), -32, 160, 80, 64, -0.1, 0, 24, 0.1),
