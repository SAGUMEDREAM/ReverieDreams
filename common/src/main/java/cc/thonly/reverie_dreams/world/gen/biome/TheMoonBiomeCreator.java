...
public class TheMoonBiomeCreator {
    ...
    public static Biome createTheMoon(HolderGetter<PlacedFeature> featureLookup, HolderGetter<ConfiguredWorldCarver<?>> carverLookup) {
        ...
        lookupBackedBuilder.addFeature(Decoration.RAW_GENERATION, RDBuiltinPlacedFeatures.CRATER_MEGA_KEY);
        lookupBackedBuilder.addFeature(Decoration.RAW_GENERATION, RDBuiltinPlacedFeatures.CRATER_LARGE_KEY);
        lookupBackedBuilder.addFeature(Decoration.RAW_GENERATION, RDBuiltinPlacedFeatures.CRATER_SMALL_KEY);
