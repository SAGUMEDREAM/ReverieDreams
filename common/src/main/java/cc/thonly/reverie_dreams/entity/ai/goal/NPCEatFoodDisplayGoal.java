...
public class NPCEatFoodDisplayGoal extends MoveToBlockGoal {

    protected int timer;

    public NPCEatFoodDisplayGoal(BaseNPCLikeEntity maid, final double speed, final int range, final int maxYDifference) {
