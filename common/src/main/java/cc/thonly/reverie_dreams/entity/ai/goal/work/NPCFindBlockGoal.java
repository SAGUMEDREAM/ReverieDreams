...
import cc.thonly.reverie_dreams.mixin.accessor.BlockBehaviourAccessor;
...
//            System.out.println("=== Tick end ===");
            ...
            if (this.useAction && this.targetBlock != null && !blockState.isAir() && blockState.is(this.targetBlock)) {
                ...
                try {
                    ((BlockBehaviourAccessor) this.targetBlock).reverie_dreams$useItemOn(this.roleEntity.getItemBySlot(EquipmentSlot.MAINHAND),
                            blockState,
                            serverLevel,
                            this.currentTarget,
                    ...
                    ((BlockBehaviourAccessor) this.targetBlock).reverie_dreams$useWithoutItem(
                            blockState,
                            serverLevel,
                            this.currentTarget,
