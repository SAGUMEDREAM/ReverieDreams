...
public class NPCFindWaterGoal extends Goal {
    ...
    public NPCFindWaterGoal(BaseNPCLikeEntity roleEntity) {
        this.roleEntity = roleEntity;
        this.workMode = NPCWorkModes.FISHING;
        this.targetBlock = Blocks.WATER;
...
//        System.out.println("=== Tick end ===");
    ...
    private boolean isReached(BlockPos pos) {
        return pos.distToCenterSqr(this.roleEntity.position()) <= 4 * 4;
    }
