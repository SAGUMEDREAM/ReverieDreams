...
public class AvoidFireDamageEntityGoal extends Goal {
    ...
    public AvoidFireDamageEntityGoal(PathfinderMob pathfinderMob, float f, double d, double e) {
        this(pathfinderMob, livingEntity -> true, f, d, e, EntitySelector.NO_CREATIVE_OR_SPECTATOR);
    }

    public AvoidFireDamageEntityGoal(
    ...
    public AvoidFireDamageEntityGoal(PathfinderMob pathfinderMob, float f, double d, double e, Predicate<? super LivingEntity> predicate) {
    ...
    public boolean canUse() {
        this.toAvoid = getServerLevel(this.mob)
                .getNearestEntity(
                        this.mob.level().getEntitiesOfClass(LivingEntity.class, this.mob.getBoundingBox().inflate(this.maxDist, 3.0, this.maxDist), livingEntity -> true),
    ...
    public void start() {
        ...
        if (this.toAvoid != null && !this.toAvoid.hasEffect(MobEffects.SPEED)) {
            this.toAvoid.addEffect(new MobEffectInstance(MobEffects.SPEED, 1, 1, false, false, true));
        }
    }
