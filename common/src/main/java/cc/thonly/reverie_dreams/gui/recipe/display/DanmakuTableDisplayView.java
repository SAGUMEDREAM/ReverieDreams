...
public class DanmakuTableDisplayView extends SimpleGui implements DisplayView {
    ...
    public void init() {
        ...
        List<IngredientStack> inputs = new LinkedList<>();
    ...
    public void back(int index, ClickType clickType, net.minecraft.world.inventory.ClickType input, GuiInterface slotBasedGui) {
