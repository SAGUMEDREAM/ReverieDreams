...
//                        .updateInterval(DANMAKU_RATE)
    ...
    public static RegistrySupplier<EntityType<BaguaFurnaceEntity>> BAGUA_FURNACE = registerEntity("bagua_furnace",
            () -> EntityType.Builder.of(BaguaFurnaceEntity::new, MobCategory.MISC));
    public static RegistrySupplier<EntityType<KnifeEntity>> KNIFE = registerEntity("knife",
    ...
    public static RegistrySupplier<EntityType<MagicBroom>> MAGIC_BROOM = registerEntityWithSpawnEgg("broom",
    ...
    public static RegistrySupplier<EntityType<Wheelchair>> WHEEL_CHAIR = registerEntityWithSpawnEgg("wheel_chair",
            () -> EntityType.Builder.<Wheelchair>of(Wheelchair::new, MobCategory.MISC).ridingOffset(0.4f),
            Wheelchair::createLivingAttributes);
    public static RegistrySupplier<EntityType<Scarecrow>> SCARECROW = registerEntityWithSpawnEgg("scarecrow",
    ...
    public static RegistrySupplier<EntityType<Ghost>> GHOST = registerEntityWithSpawnEgg("ghost",
    ...
    public static RegistrySupplier<EntityType<Yousei>> YOUSEI = registerEntityWithSpawnEgg("yousei",
    ...
    public static RegistrySupplier<EntityType<MaidYousei>> MAID_YOUSEI = registerEntityWithSpawnEgg("maid_yousei",
    ...
    public static RegistrySupplier<EntityType<SunflowerYousei>> SUNFLOWER_YOUSEI = registerEntityWithSpawnEgg("sunflower_yousei",
    ...
    public static RegistrySupplier<EntityType<Goblin>> GOBLIN = registerEntityWithSpawnEgg("goblin",
    ...
    public static RegistrySupplier<EntityType<RabbitUnit>> RABBIT_UNIT = registerEntityWithSpawnEgg("rabbit_unit",
    ...
    public static RegistrySupplier<EntityType<WaterElementalEntity>> WATER_ELEMENTAL = registerEntityWithSpawnEgg("water_elemental",
            () -> EntityType.Builder.of(WaterElementalEntity::new, MobCategory.MONSTER),
            WaterElementalEntity::createLivingAttributes
    );
    public static RegistrySupplier<EntityType<FireElementalEntity>> FIRE_ELEMENTAL = registerEntityWithSpawnEgg("fire_elemental",
            () -> EntityType.Builder.of(FireElementalEntity::new, MobCategory.MONSTER),
            FireElementalEntity::createLivingAttributes
    );
    public static RegistrySupplier<EntityType<IceElementalEntity>> ICE_ELEMENTAL = registerEntityWithSpawnEgg("ice_elemental",
            () -> EntityType.Builder.of(IceElementalEntity::new, MobCategory.MONSTER),
            IceElementalEntity::createLivingAttributes
    );
    public static RegistrySupplier<EntityType<Hairball>> HAIRBALL = registerEntityWithSpawnEgg("hairball",
            () -> EntityType.Builder.of(Hairball::new, MobCategory.MONSTER).sized(1, 1),
            Hairball::createAttributes
    );
    public static RegistrySupplier<EntityType<UFO>> UFO = registerEntityWithSpawnEgg("ufo",
    ...
    public static RegistrySupplier<EntityType<MushroomMonster>> MUSHROOM_MONSTER = registerEntityWithSpawnEgg("mushroom_monster",
