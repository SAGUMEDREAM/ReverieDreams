...
public class RDEntityTypes {
    public static final Map<RegistryDelegate<EntityType<?>>, ItemDelegate> SPAWN_EGG_BIND = new Object2ObjectOpenHashMap<>(128);
    public static final List<RegistryDelegate<EntityType<?>>> ENTITY_TYPES = new ArrayList<>(128);
    ...
    public static final RegistryDelegate<EntityType<NPCCompanionEntity>> NPC_SIMPLE_ENTITY = registerEntity("base_character",
            () -> EntityType.Builder.of(NPCCompanionEntity::new, MobCategory.MISC)
                    .ridingOffset(-0.6F),
            BaseNPCLikeEntity::createLivingAttributes);
    public static final RegistryDelegate<EntityType<DanmakuEntity>> DANMAKU = registerEntity("danmaku_bullet",
...
//                        .updateInterval(DANMAKU_RATE)
    ...
    public static final RegistryDelegate<EntityType<BaguaFurnaceEntity>> BAGUA_FURNACE = registerEntity("bagua_furnace",
            () -> EntityType.Builder.of(BaguaFurnaceEntity::new, MobCategory.MISC));
    public static final RegistryDelegate<EntityType<KnifeEntity>> KNIFE = registerEntity("knife",
            () -> EntityType.Builder.of(KnifeEntity::new, MobCategory.MISC));
    public static final RegistryDelegate<EntityType<OreEspEntity>> ORE_ESP = registerEntity("ore_esp_entity",
            () -> EntityType.Builder.of(OreEspEntity::new, MobCategory.MISC));
    public static final RegistryDelegate<EntityType<SeatEntity>> SEAT = registerEntity("seat",
            () -> EntityType.Builder.<SeatEntity>of(SeatEntity::new, MobCategory.MISC)
                    .noLootTable()
                    .ridingOffset(0)
                    .sized(0.5f, 0.5f)
    );
    public static final RegistryDelegate<EntityType<FumoSeller>> FUMO_SELLER_VILLAGER = registerEntityWithSpawnEgg("fumo_seller_villager",
    ...
    public static final RegistryDelegate<EntityType<MagicBroom>> MAGIC_BROOM = registerEntityWithSpawnEgg("broom",
    ...
    public static final RegistryDelegate<EntityType<Wheelchair>> WHEEL_CHAIR = registerEntityWithSpawnEgg("wheel_chair",
            () -> EntityType.Builder.<Wheelchair>of(Wheelchair::new, MobCategory.MISC).ridingOffset(0.4f),
            Wheelchair::createLivingAttributes);
    public static final RegistryDelegate<EntityType<Scarecrow>> SCARECROW = registerEntityWithSpawnEgg("scarecrow",
            () -> EntityType.Builder.<Scarecrow>of(Scarecrow::new, MobCategory.MISC),
            Scarecrow::createLivingAttributes
    );
    public static final RegistryDelegate<EntityType<KillerBee>> KILLER_BEE = registerEntityWithSpawnEgg("killer_bee",
    ...
    public static final RegistryDelegate<EntityType<MoonRabbit>> MOON_RABBIT = registerEntityWithSpawnEgg("moon_rabbit",
    ...
    public static final RegistryDelegate<EntityType<Ghost>> GHOST = registerEntityWithSpawnEgg("ghost",
    ...
    public static final RegistryDelegate<EntityType<Yousei>> YOUSEI = registerEntityWithSpawnEgg("yousei",
    ...
    public static final RegistryDelegate<EntityType<MaidYousei>> MAID_YOUSEI = registerEntityWithSpawnEgg("maid_yousei",
    ...
    public static final RegistryDelegate<EntityType<SunflowerYousei>> SUNFLOWER_YOUSEI = registerEntityWithSpawnEgg("sunflower_yousei",
    ...
    public static final RegistryDelegate<EntityType<IceFairy>> ICE_FAIRY = registerEntityWithSpawnEgg("ice_fairy",
    ...
    public static final RegistryDelegate<EntityType<Goblin>> GOBLIN = registerEntityWithSpawnEgg("goblin",
    ...
    public static final RegistryDelegate<EntityType<RabbitUnit>> RABBIT_UNIT = registerEntityWithSpawnEgg("rabbit_unit",
    ...
    public static final RegistryDelegate<EntityType<WaterElementalEntity>> WATER_ELEMENTAL = registerEntityWithSpawnEgg("water_elemental",
            () -> EntityType.Builder.of(WaterElementalEntity::new, MobCategory.MONSTER),
            WaterElementalEntity::createLivingAttributes
    );
    public static final RegistryDelegate<EntityType<FireElementalEntity>> FIRE_ELEMENTAL = registerEntityWithSpawnEgg("fire_elemental",
            () -> EntityType.Builder.of(FireElementalEntity::new, MobCategory.MONSTER),
            FireElementalEntity::createLivingAttributes
    );
    public static final RegistryDelegate<EntityType<IceElementalEntity>> ICE_ELEMENTAL = registerEntityWithSpawnEgg("ice_elemental",
            () -> EntityType.Builder.of(IceElementalEntity::new, MobCategory.MONSTER),
            IceElementalEntity::createLivingAttributes
    );
    public static final RegistryDelegate<EntityType<Hairball>> HAIRBALL = registerEntityWithSpawnEgg("hairball",
            () -> EntityType.Builder.of(Hairball::new, MobCategory.MONSTER).sized(1, 1),
            Hairball::createAttributes
    );
    public static final RegistryDelegate<EntityType<UFO>> UFO = registerEntityWithSpawnEgg("ufo",
    ...
    public static final RegistryDelegate<EntityType<MushroomMonster>> MUSHROOM_MONSTER = registerEntityWithSpawnEgg("mushroom_monster",
            () -> EntityType.Builder.of(MushroomMonster::new, MobCategory.MONSTER),
            MushroomMonster::createAttributes
    );
    public static RegistryDelegate<EntityType<WildPig>> WILD_PIG = registerEntityWithSpawnEgg("wild_pig",
    ...
    public static RegistryDelegate<EntityType<TavernVillager>> TAVERN_VILLAGER = registerEntityWithSpawnEgg("tavern_villager",
    ...
    public static RegistryDelegate<EntityType<Oni>> ONI = registerEntityWithSpawnEgg("oni",
    ...
    public static final RegistryDelegate<EntityType<ThrownCuisineItem>> THROWN_CUISINE_ITEM = registerEntity("thrown_cuisine_item",
    ...
    public static final RegistryDelegate<EntityType<NPCFishingHook>> FISHING_BOBBER = registerEntity("fishing_bobber",
...
//                    new ClientAsset.ResourceTexture(ReverieDreams.id("entity/pig/wild_pig"), ReverieDreams.id("entity/pig/wild_pig"))
    ...
    public static <T extends Entity> RegistryDelegate<EntityType<T>> registerEntity(String name, Supplier<EntityType.Builder<T>> entityType) {
        RegistryDelegate<EntityType<T>> supplier = MCBuiltInRegistries.ENTITY_TYPE.register(name, () -> entityType.get().build(ResourceKey.create(Registries.ENTITY_TYPE, ReverieDreams.id(name))));
        RegistryDelegate<EntityType<?>> cast = (RegistryDelegate<EntityType<?>>) ((Object) supplier);
        ENTITY_TYPES.add(cast);
        return supplier;
    }

    public static <T extends Entity> RegistryDelegate<EntityType<T>> registerEntity(String path, @NotNull Supplier<EntityType.Builder<T>> entityType, @Nullable CreateAttributesBuilderFunction function) {
        RegistryDelegate<EntityType<T>> registeredEntity = registerEntity(path, entityType);
        if (function != null) {
            EntityAttributeRegistry.register(registeredEntity, function);
        }
        return registeredEntity;
    }

    public static <T extends Entity> @NotNull RegistryDelegate<EntityType<T>> registerEntityWithSpawnEgg(String name, Supplier<EntityType.Builder<T>> entityType, CreateAttributesBuilderFunction function) {
        RegistryDelegate<EntityType<T>> registeredEntity = MCBuiltInRegistries.ENTITY_TYPE.register(name, () -> entityType.get().build(of(name)));
        String eggName = name + "_spawn_egg";
        ItemDelegate item = registerSpawnEggItem(eggName, registeredEntity);
        RegistryDelegate<EntityType<?>> cast = (RegistryDelegate<EntityType<?>>) ((Object) registeredEntity);
        EntityAttributeRegistry.register(registeredEntity, function);
        SPAWN_EGG_BIND.put(cast, item);
        return registeredEntity;
    }

    public static <T extends Entity> ItemDelegate registerSpawnEggItem(String eggName, RegistryDelegate<EntityType<T>> supplier) {
        RegistryDelegate<Item> item = MCBuiltInRegistries.ITEM.register(eggName, () -> new ColoredSpawnEggItem(eggName, (EntityType<? extends Mob>) supplier.value(), new Item.Properties()));
