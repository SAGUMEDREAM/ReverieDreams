...
public class RDItems {
    ...
    public static void initialize(BalmItemRegistrar balmItemRegistrar) {
        ...
        SILVER_SPEAR = registerItem(balmItemRegistrar, "silver_spear", props -> new Item(props.spear(SilverMaterial.INSTANCE, 0.95F, 0.95F, 0.6F, 2.5F, 8.0F, 6.75F, 5.1F, 11.25F, 4.6F)), new Item.Properties());
        ...
        MAGIC_ICE_SPEAR = registerItem(balmItemRegistrar, "magic_ice_spear", props -> new Item(props.spear(MagicIceMaterial.INSTANCE, 0.95F, 0.95F, 0.6F, 2.5F, 8.0F, 6.75F, 5.1F, 11.25F, 4.6F)), new Item.Properties());
        ...
        DREAM_SPEAR = registerItem(balmItemRegistrar, "dream_spear", props -> new Item(props.spear(DreamMaterial.INSTANCE, 0.95F, 0.95F, 0.6F, 2.5F, 8.0F, 6.75F, 5.1F, 11.25F, 4.6F)), new Item.Properties());
