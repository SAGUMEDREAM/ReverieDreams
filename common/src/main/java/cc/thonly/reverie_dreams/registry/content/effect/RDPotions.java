...
public class RDPotions {
    ...
    public static RegistrySupplier<Potion> ELIXIR_OF_LIFE_POTION_INF = registerPotion("elixir_of_life_inf", () -> new Potion("elixir_of_life", new MobEffectInstance(RDStatusEffects.ELIXIR_OF_LIFE, Integer.MAX_VALUE, 0)));
    ...
    public static RegistrySupplier<Potion> registerPotion(String id, Supplier<Potion> potion) {
        var holder = ReverieDreamsRegistries.POTION.register(id, potion);
        POTIONS.add(holder);
        return holder;
    }
}
