...
public class RDBeverageItems {
    ...
    public static ItemDelegate BIG_POPSICLE = registerBeverageItem("big_popsicle", beverageFactory(), new Item.Properties());
    ...
    public static ItemDelegate MILK = registerBeverageItem("milk", beverageFactory(), new Item.Properties());
