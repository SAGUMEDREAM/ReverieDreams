...
public class DanmakuCraftingTableRecipeCategory implements IRecipeCategory<DanmakuRecipe> {
    private final IGuiHelper helper;
    private final Component title;
    private final IDrawable icon;
    private final IDrawable arrow;

    public DanmakuCraftingTableRecipeCategory(IGuiHelper helper) {
        this.title = RDBlocks.DANMAKU_CRAFTING_TABLE.asBlock().getName();
        this.helper = helper;
    ...
    @Override
    public IRecipeType<DanmakuRecipe> getRecipeType() {
        return JeiRecipeTypes.DANMAKU;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, DanmakuRecipe recipe, IFocusGroup focuses) {
