...
public class SoundEventPlayUtils {
    public static void playSound(LivingEntity livingEntity, SoundEvent event, SoundSource source) {
        Level level = livingEntity.level();
        level.playSound(null, livingEntity.getX(), livingEntity.getY(), livingEntity.getZ(), event, source);
    }

    public static void playSound(LivingEntity livingEntity, SoundEvent event, SoundSource source, float volume, float pitch) {
        Level level = livingEntity.level();
        level.playSound(null, livingEntity.getX(), livingEntity.getY(), livingEntity.getZ(), event, source, volume, pitch);
    }
