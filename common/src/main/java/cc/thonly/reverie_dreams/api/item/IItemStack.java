...
public interface IItemStack extends NonPersistentAdditionalData{

    public static IItemStack getMixinImpl(ItemStack itemStack) {
        return (IItemStack) (Object) itemStack;
    }
