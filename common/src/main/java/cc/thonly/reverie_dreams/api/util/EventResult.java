...
public final class EventResult {
    ...
    private static final EventResult STOP = new EventResult(true, (Boolean)null);
    private static final EventResult PASS = new EventResult(false, (Boolean)null);
    ...
    public InteractionResult asMinecraft() {
        if (this.isPresent()) {
            return (InteractionResult)(this.value() ? InteractionResult.SUCCESS : InteractionResult.FAIL);
        } else {
