...
public class ReverieDreamsExtensionEvents {
    public static final Event<EntryPoint> ADD_EVENT = EventFactory.createArrayBacked(
            EntryPoint.class,
            (listeners) -> () -> {
    ...
    public static final Event<FabricEntryPoint> SCAN_EVENT = EventFactory.createArrayBacked(
            FabricEntryPoint.class,
            (listeners) -> () -> {
