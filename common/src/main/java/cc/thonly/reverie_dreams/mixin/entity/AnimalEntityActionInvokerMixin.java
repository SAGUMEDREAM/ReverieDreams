...
@Mixin(Animal.class)
public abstract class AnimalEntityActionInvokerMixin extends AgeableMob implements AnimalEntityActionInvoker {

    @Shadow private int inLove;

    protected AnimalEntityActionInvokerMixin(EntityType<? extends AgeableMob> entityType, Level world) {
