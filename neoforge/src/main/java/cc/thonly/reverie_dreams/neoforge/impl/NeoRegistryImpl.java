...
public class NeoRegistryImpl<T> extends RegistryImpl<T> {
    ...
    public NeoRegistryImpl(ResourceKey<? extends Registry<T>> key) {
        super(key);
    }

    public NeoRegistryImpl(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle) {
        super(key, lifecycle);
    }

    public NeoRegistryImpl(ResourceKey<? extends Registry<T>> key, @org.jetbrains.annotations.Nullable RegistryImpl<T> parent) {
        super(key, parent);
    }

    public NeoRegistryImpl(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle, @org.jetbrains.annotations.Nullable RegistryImpl<T> parent) {
