...
public class NeoRegistryHandlerImpl<T> extends RegistryHandler<T> {
    ...
    public NeoRegistryHandlerImpl(ResourceKey<? extends Registry<T>> key) {
        super(key);
    }

    public NeoRegistryHandlerImpl(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle) {
        super(key, lifecycle);
    }

    public NeoRegistryHandlerImpl(ResourceKey<? extends Registry<T>> key, @org.jetbrains.annotations.Nullable RegistryHandler<T> parent) {
        super(key, parent);
    }

    public NeoRegistryHandlerImpl(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle, @org.jetbrains.annotations.Nullable RegistryHandler<T> parent) {
