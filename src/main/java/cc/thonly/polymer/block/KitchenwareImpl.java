...
public class KitchenwareImpl implements FactoryBlock, PolymerTexturedBlock, TransparentFlatTripWire {
    private final AbstractKitchenwareBlock block;
    public KitchenwareImpl(AbstractKitchenwareBlock block) {
        this.block = block;
    }
    ...
    public class Model extends BlockModel {
        ...
        public void init(BlockState state) {
            ...
            main.setOffset(KitchenwareImpl.this.block.getOffset());
            main.setScale(KitchenwareImpl.this.block.getScale());
            main.setYaw(yaw);
            addElement(main);
        }
