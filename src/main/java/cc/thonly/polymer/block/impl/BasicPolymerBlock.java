...
@Getter
@ToString
public class BasicPolymerBlock extends Block implements PolymerBlock, PolymerTexturedBlock {
    BlockState polymerBlockState;

    public BasicPolymerBlock(BlockModelType blockModelType, Properties properties) {
        super(properties);
