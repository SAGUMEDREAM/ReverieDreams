...
public class MoneyShopClerk {
    ...
    public static void registers() {
        // 等级 1：铜 <-> 银
        TradeOfferHelper.registerVillagerOffers(BuiltInRegistries.VILLAGER_PROFESSION.getValue(RDVillagerProfessions.MONEY_SHOP_CLERK), 1, factories -> {
            // 铜 → 银
        ...
        // 等级 2：银 <-> 金
        TradeOfferHelper.registerVillagerOffers(BuiltInRegistries.VILLAGER_PROFESSION.getValue(RDVillagerProfessions.MONEY_SHOP_CLERK), 2, factories -> {
            // 银 → 金
            factories.add((entity, random) -> new MerchantOffer(
