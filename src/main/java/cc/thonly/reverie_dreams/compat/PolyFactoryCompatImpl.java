...
public class PolyFactoryCompatImpl {
    ...
    public static void bootstrap() {
        ...
        ConstantInfo.POLYFACTORY_HAND_CRANK = FactoryBlocks.HAND_CRANK;
    ...
    public static List<Tuple<Integer, Goal>> getGoals(BaseNPCLikeEntity npcLikeEntity) {
        if (!ConstantInfo.hasPolyfactory() || ConstantInfo.POLYFACTORY_HAND_CRANK == Blocks.AIR) {
            return List.of();
        }
        return List.of(new Tuple<>(0, new NPCFindBlockGoal(npcLikeEntity, NPCWorkModes.POLYFACTORY_HAND_CRANK, ConstantInfo.POLYFACTORY_HAND_CRANK, true, true)));
    }
}
