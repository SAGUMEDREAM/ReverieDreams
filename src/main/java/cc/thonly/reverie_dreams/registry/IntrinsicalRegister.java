...
public class IntrinsicalRegister<T> implements WritableRegistry<T> {
    ...
    public IntrinsicalRegister(ResourceKey<? extends Registry<T>> key) {
        this(key, Lifecycle.stable());
    }

    public IntrinsicalRegister(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle) {
        this.key = key;
    ...
    public IntrinsicalRegister(ResourceKey<? extends Registry<T>> key, @Nullable IntrinsicalRegister<T> parent) {
        this(key, Lifecycle.stable(), parent);
    }

    public IntrinsicalRegister(ResourceKey<? extends Registry<T>> key, Lifecycle lifecycle, @Nullable IntrinsicalRegister<T> parent) {
        this(key, lifecycle);
        this.parent = parent;
    }
    ...
    public IntrinsicalRegister<T> defaultId(ResourceLocation defaultId) {
