...
public class SpellcardItem extends Item {
    ...
    private InteractionResult spell(Level level, Player player, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel world) {
            ...
            SpellcardRenderer renderer = itemStack.get(RDDataComponents.SPELL_CARD_COMPONENT);
            if (renderer == null) {
            ...
            world.playSound(null, player.getX(), player.getEyeY(), player.getZ(), SoundEventInit.SPELL_CARD, player.getSoundSource(), 1.0f, 1.0f);
