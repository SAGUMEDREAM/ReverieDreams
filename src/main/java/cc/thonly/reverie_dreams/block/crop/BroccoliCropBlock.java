...
public class BroccoliCropBlock extends AbstractCropBlock {
    public static final MapCodec<BroccoliCropBlock> CODEC = BroccoliCropBlock.simpleCodec(BroccoliCropBlock::new);
