...
public class ChestLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        lootTableBiConsumer.accept(DREAM_CHEST, LootTable
                ...
                .withPool(
                        LootPool.lootPool().setRolls(ConstantValue.exactly(3))
                                ...
                                .add(LootItem.lootTableItem(RDItems.DREAM_CRYSTAL_FRAGMENT).setWeight(5))
                )
                .withPool(
                        LootPool.lootPool().setRolls(ConstantValue.exactly(2))
                                ...
                                .add(LootItem.lootTableItem(RDItems.POINT).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.POWER).setWeight(1))
                )
                .withPool(
                        LootPool.lootPool().setRolls(ConstantValue.exactly(2))
                                .add(LootItem.lootTableItem(RDWoodBlocks.LEMON.sapling().asItem()).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.UPGRADED_HEALTH).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.UPGRADED_HEALTH_FRAGMENT).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.BOMB).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.BOMB_FRAGMENT).setWeight(1))
                )
        );
                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool().setRolls(UniformGenerator.between(1, 4))
                                        ...
                                        .add(LootItem.lootTableItem(RDItems.UPGRADED_HEALTH_FRAGMENT).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 2.0f))))
                                        .add(LootItem.lootTableItem(RDItems.BOMB_FRAGMENT))
                                        .add(LootItem.lootTableItem(RDItems.COOKIE).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 2.0f))))
                        )
                        .withPool(
                                LootPool.lootPool().setRolls(UniformGenerator.between(1, 3))
                                        .add(LootItem.lootTableItem(Items.GOLD_INGOT))
                                        .add(LootItem.lootTableItem(Items.IRON_INGOT))
                                        .add(LootItem.lootTableItem(RDItems.POWER).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 3.0f))))
                                        .add(LootItem.lootTableItem(RDItems.POINT).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 3.0f))))
                        )
                        .withPool(
                                LootPool.lootPool().setRolls(UniformGenerator.between(1, 3))
                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool().setRolls(UniformGenerator.between(1, 3))
                                        ...
                                        .add(LootItem.lootTableItem(RDItems.EXORCISM_PAPER))
                        )
                        .withPool(
                                LootPool.lootPool().setRolls(UniformGenerator.between(1, 3))
        ...
        for (Item drinkItem : RDFoodItems.FOOD_ITEMS) {
        ...
        for (Item drinkItem : RDIngredientItems.INGREDIENTS) {
        ...
        lootTableBiConsumer.accept(SAKURAZUKA_CHEST,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(RDItems.POINT).setWeight(1))
                                .add(LootItem.lootTableItem(RDItems.POWER).setWeight(1))
                                .add(LootItem.lootTableItem(RDBlocks.POINT_BLOCK).setWeight(1))
                                .add(LootItem.lootTableItem(RDBlocks.POWER_BLOCK).setWeight(1))
                                .add(LootItem.lootTableItem(Items.IRON_SWORD).setWeight(6))
                                .add(LootItem.lootTableItem(RDItems.COPPER_COIN).setWeight(4))
