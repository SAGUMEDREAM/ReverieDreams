...
public class PointOfInterestTypeProvider extends cc.thonly.reverie_dreams.datagen.generator.PointOfInterestTypeProvider {
    ...
    protected void addTags(HolderLookup.Provider wrapperLookup) {
        ...
        var builder = getOrCreateTagBuilder(PoiTypeTags.ACQUIRABLE_JOB_SITE);
        builder.add(registryWrapper.getOrThrow(RDPointOfInterestTypes.HAWKERS).value());
        builder.add(registryWrapper.getOrThrow(RDPointOfInterestTypes.PRIEST).value());
        builder.add(registryWrapper.getOrThrow(RDPointOfInterestTypes.MONEY_SHOP_CLERK).value());
    }
}
