package cc.thonly.reverie_dreams.fabric.polymer.mixin.item;
...
public abstract class CameraItemMixin extends SimplePolymerItem {
    ...
    public void inventoryTick(ItemStack itemStack, ServerLevel serverLevel, Entity entity, @Nullable EquipmentSlot slot) {
        ...
        ItemStack newItem = new ItemStack(RDItems.HIMEKAIDOU_HATATES_PHONE.asItem().builtInRegistryHolder(), itemStack.getCount(), itemStack.getComponentsPatch());
        if (slot != null) {
