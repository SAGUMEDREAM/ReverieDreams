...
public class RecipeTypeProvider extends AbstractRecipeTypeProvider {
    ...
    public void offerShapeRecipe(DanmakuType type, List<List<Boolean>> shape) {
        this.danmakuShapeDrawRecipeFactory.register(type.getId(), new DanmakuShapeDrawRecipe(shape, ItemStackWrapper.of(type.toShape().getItemStack().copy())));
    }
    ...
    public void registerRoleCard(RoleCard.RecipeBuilder builder) {
        this.gensokyoAltarRecipeFactory.register(builder.getRoleCard().getId(), builder.getResult());
    }
